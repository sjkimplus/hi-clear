...
class ScheduleServiceTest {
    ...
    void setUp() {
        ...
        schedule = Schedule.builder()
                ...
                .endTime(LocalDateTime.of(2024, 11, 28, 12, 0))
    ...
    void create_fail_notClubMember() {
        // Given
        ScheduleRequest request = new ScheduleRequest("Test Schedule Title", "This is a test description.", "Seoul",
                LocalDateTime.of(2024, 11, 28, 10, 0), LocalDateTime.of(2024, 11, 28, 12, 0),
                List.of(user.getId()));
    ...
    void create_fail_invalidScheduleTime() {
        // Given
        ScheduleRequest request = new ScheduleRequest("Test Schedule Title", "This is a test description.", "Seoul",
                LocalDateTime.of(2024, 11, 28, 12, 0), // 시작 시간이 종료 시간보다 늦음
                LocalDateTime.of(2024, 11, 28, 10, 0), // 종료 시간
                List.of(user.getId()));
